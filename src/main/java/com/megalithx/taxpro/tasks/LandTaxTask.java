...
public class LandTaxTask {
    ...
    public void startTaxing() {
        ...
        // Collect claim sizes efficiently from GP datastore
        ...
        processBatch(owners, playerBlocks, 0, 50); // 50 players per sec
    }
        ...
        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
            ...
            for (int i = index; i < max; i++) {
                try {
                    ...
                    // Determine taxable blocks based on configured method
